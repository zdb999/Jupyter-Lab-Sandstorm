...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "6k0rwg5d8f9g8v8r9qj6xupu8cvwjfdcv2329z2ujkpcr2c7gvkh",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "Jupyter Lab"),

    appVersion = 0,  # Increment this for every release.

    appMarketingVersion = (defaultText = "1.2.6"),
    ...
    metadata = (
      ...
      icons = (
        ...
        appGrid = (svg = embed "icons/jupyter.svg"),
        grain = (svg = embed "icons/jupyter_small.svg"),
        market = (svg = embed "icons/jupyter.svg"),
        marketBig = (svg = embed "icons/jupyter.svg"),
      ),

      website = "https://jupyter.org/",
      # This should be the app's main website url.

      codeUrl = "https://github.com/jupyterlab/jupyterlab",
      ...
      author = (
        ...
        upstreamAuthor = "Project Jupyter",
      ),
      ...
      shortDescription = (defaultText = "Jupyter notebook editor"),
...
const myCommand :Spk.Manifest.Command = (
  ...
  environ = [
    ...
    (key = "PATH", value = "/opt/app/anaconda3/bin/:/usr/local/bin:/usr/bin:/bin"),
